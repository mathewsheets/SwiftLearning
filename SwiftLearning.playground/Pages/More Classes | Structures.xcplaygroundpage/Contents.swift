...
struct Term {
    ...
    func dateRange() -> String {
        ...
        return "\(DateUtils.dateString(from: start)) - \(DateUtils.dateString(from: end))"
    }
}
...
struct Term2 {
    ...
    mutating func setTerm(start: Date) {
...
term2.setTerm(start: DateUtils.createDate(year: 1833, month: 3, day: 4)!)
...
president2.party.sayThankYou(president: president2.name!)
/*:
