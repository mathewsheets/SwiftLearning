...
public func getPresidentsBy(century: Int) -> [String] {
...
public func getAllPresidents() -> [String] {
    ...
    presidents.append(contentsOf: getPresidentsBy(century: 18))
    presidents.append(contentsOf: getPresidentsBy(century: 19))
    presidents.append(contentsOf: getPresidentsBy(century: 20))
    presidents.append(contentsOf: getPresidentsBy(century: 21))
